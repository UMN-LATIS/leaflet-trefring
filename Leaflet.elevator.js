...
// With no `attribution` option, remove `attributionControl` all together.
    adjustAttribution: function() {
        L.Control.Attribution.prototype.options.prefix = true;

        if(!this.options.attribution) {
            this._map.options.attributionControl = false;
            //this._map.attributionControl.remove() //commented out so that a minimap layer could be added via elevator
        }
    },
